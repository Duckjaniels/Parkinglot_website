...
const Pricing = () => (
  <div className="app__pricing flex__center " id="pricing">
      ...
      <img className="app__pricing-backgroundimage-image" src={images.bg_pricing} alt="bg_parkinglot"/>
      </div>
          ...
          <div className="app__pricing-subscription flex__center">
              ...
              <div className="app__pricing-items">
                  {data.subscription.map((vehicle, index) =>(
                      <PricingItem key={vehicle.title + index} title={vehicle.title} price={vehicle.price} tags={vehicle.tags}/>
                  ))}
              </div>
          </div>
